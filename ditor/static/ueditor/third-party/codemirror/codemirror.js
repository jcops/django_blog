...
//
// All functions that need access to the DjangoUeditor's state live inside
// the CodeMirror function. Below that, at the bottom of the file,
// some utilities are defined.

// CodeMirror is the only global var we claim
var CodeMirror = (function() {
    // This is the function that produces an DjangoUeditor instance. It's
    // closure is used to store the DjangoUeditor state.
    function CodeMirror(place, givenOptions) {
        ...
        // The element in which the DjangoUeditor lives.
        var wrapper = targetDocument.createElement("div");
        wrapper.className = "CodeMirror" + (options.lineWrapping ? " CodeMirror-wrap" : "");
        // This mess creates the base DOM structure for the DjangoUeditor.
        wrapper.innerHTML =
        ...
        function onMouseDown(e) {
            ...
            // For button 1, if it was clicked inside the DjangoUeditor
        ...
        function updateDisplay(changes, suppressCallback) {
            ...
            // This is just a bogus formula that detects when the DjangoUeditor is
